...
fun buildJavaField(name: String, type: IrType, builder: JPFieldBuilder.() -> Unit = {}): JPField =
...
fun buildJavaParameter(name: String, type: IrType, builder: JPParameterBuilder.() -> Unit = {}): JPParameter =
...
fun buildJavaFile(className: IrClassType, builder: () -> JPClass): JPFile =
    JPFile
