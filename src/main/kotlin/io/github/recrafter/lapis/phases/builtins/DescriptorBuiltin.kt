...
sealed class DescriptorBuiltin<D : IrDescriptor, W : IrDescriptorWrapper>(
    override val name: String,
    val builtin: SimpleBuiltin,
) : Builtin<KPClass> {

    data object FieldGet : DescriptorBuiltin<IrFieldDescriptor, IrDescriptorFieldGetWrapper>(
        "FieldGet", SimpleBuiltin.Field
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorFieldGetWrapper, typer: BuiltinTyper) {
    ...
    data object FieldSet : DescriptorBuiltin<IrFieldDescriptor, IrDescriptorFieldSetWrapper>(
        "FieldSet", SimpleBuiltin.Field
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorFieldSetWrapper, typer: BuiltinTyper) {
            val receiverParameter = wrapper.receiverTypeName?.let {
                IrParameter(
    ...
    data object ArrayGet : DescriptorBuiltin<IrFieldDescriptor, IrDescriptorArrayGetWrapper>(
        "ArrayGet", SimpleBuiltin.Field
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorArrayGetWrapper, typer: BuiltinTyper) {
    ...
    data object ArraySet : DescriptorBuiltin<IrFieldDescriptor, IrDescriptorArraySetWrapper>(
        "ArraySet", SimpleBuiltin.Field
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorArraySetWrapper, typer: BuiltinTyper) {
            val arrayParameter = IrParameter(
                "array".withInternalPrefix(),
                wrapper.arrayTypeName,
                listOf(IrModifier.PUBLIC)
    ...
    data object Body : DescriptorBuiltin<IrInvokableDescriptor, IrDescriptorBodyWrapper>(
        "Body", SimpleBuiltin.Method
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorBodyWrapper, typer: BuiltinTyper) {
    ...
    data object Call : DescriptorBuiltin<IrInvokableDescriptor, IrDescriptorCallWrapper>(
        "Call", SimpleBuiltin.Callable
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorCallWrapper, typer: BuiltinTyper) {
            val receiverParameter = wrapper.receiverTypeName?.let {
                IrParameter(
                    "receiver".withInternalPrefix(),
                    it,
    ...
    data object Cancel : DescriptorBuiltin<IrInvokableDescriptor, IrDescriptorCancelWrapper>(
        "Cancel", SimpleBuiltin.Method
    ) {
        override fun generateWrapper(dest: KPFileBuilder, wrapper: IrDescriptorCancelWrapper, typer: BuiltinTyper) {
    ...
    companion object {
        val entries: List<DescriptorBuiltin<*, *>> = listOf(FieldGet, FieldSet, ArrayGet, ArraySet, Body, Call, Cancel)
    }
}
